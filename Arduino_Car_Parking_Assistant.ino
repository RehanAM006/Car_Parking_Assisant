...
#define buzzer 4 // choose the pin for the Buzzer Alert

#define R_led 8 // choose the pin for the Red Led
#define Y_led 9 // choose the pin for the Yellow Led
#define G_led 10 // choose the pin for the Green Led
